    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        EmbedBuilder embedBuilder = new EmbedBuilder()
                ...
                .setDescription("**Discord | Richtlinen/Regelwerk**\n" +
                        ...
                        "> - §2. Jegliche Art von Werbung ist auf diesem Server untersagt. Ggf. kann sich an einen zuständigen Admin gewandt werden, um über eine Möglichkeit zur Werbung zu verhandeln.\n\n" +
                        "> - §3. Private Daten wie Telefonnummern, Adressen, Passwörter und ähnlichem dürfen nicht öffentlich ausgetauscht werden.\n\n" +
                        "> - §4. Alle Regeln sind einzuhalten ansonsten wird es mit Bannen, einem Kick oder anderweitig Bestraft!\n\n" +
                        "> - §5. Die Regeln dienen zur Verhaltensregeln und können jenach Situation vom den Teammitgliedern geändert werden.\n\n" +
                        ...
                        "> - §7. Behandle alle mit Respekt. Belästigung, Hexenjagd, Sexismus, Rassismus oder Volksverhetzung werden absolut nicht toleriert.\n\n" +
                        "> - §8. Keine NSFW- oder obszönen Inhalte. Dazu zählen Texte, Bilder oder Links mit Nacktheit, Sex, schwerer Gewalt oder anderen grafisch verstörenden Inhalten.\n\n" +
                        "> - §9. Es dürfen keine Bots mit dem Discord Server verbunden werden. Bots dürfen nur in ausgewiesenen Channels verbunden werden und auch nur dann, wenn kein weiterer Bot in dem Channel aktiv ist.\n\n" +
                        "> - §10. Server Admins, Moderatoren oder anderweitig befugte Admins haben volles Weisungsrecht. Das Verweigern einer bestimmten Anweisung kann zu einem Kick oder Bann führen.\n\n" +
                        "> - §11. Avatare dürfen keine pornographischen, rassistischen oder beleidigenden Inhalte beinhalten.\n\n" +
                        "> - §12. Der Umgang mit anderen Discord Benutzern sollte stets freundlich sein. Verbale Angriffe gegen andere User sind strengstens untersagt.\n\n" +
                        "> - §13. Das Einspielen von eigener Musik, oder das Übertragen von anderen nicht erwünschten Tönen ist untersagt.\n\n" +
